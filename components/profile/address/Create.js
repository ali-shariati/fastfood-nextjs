                ...
                <form onSubmit={handleSubmit(onSubmit)} className="card card-body">
                    <div className="row g-4">
                        <div className="col col-md-6">
                            ...
                            <input {...register('title', { required: 'فیلد عنوان الزامی است' })} type="text" className="form-control" />
                        ...
                        <div className="col col-md-6">
                            ...
                            <input {...register('postal_code', { required: 'فیلد کد پستی الزامی است', pattern: { value: /^\d{5}[ -]?\d{5}$/i, message: 'فیلد کد پستی معتبر نمیباشد' } })} type="text" className="form-control" />
                            <div className="form-text text-danger">{errors.postal_code?.message}</div>
                        </div>
                        <div className="col col-md-6">
                            <label className="form-label">استان</label>
                            <select {...register('province_id', { required: 'فیلد استان الزامی است' })} defaultValue="" className="form-select" aria-label="Default select example">
                        ...
                        <div className="col col-md-6">
                            ...
                            <select {...register('city_id', { required: 'فیلد شهر الزامی است' })} defaultValue="" className="form-select" aria-label="Default select example">
                        ...
                        <div className="col col-md-12">
                            ...
                            <textarea {...register('address', { required: 'فیلد آدرس الزامی است' })} type="text" rows="5" className="form-control"></textarea>
